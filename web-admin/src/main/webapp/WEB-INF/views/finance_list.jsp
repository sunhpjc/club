            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/finance/finance_list" class="nav-link active">
                                    <i class="far nav-icon fa fa-list-alt"></i>
                                    <p>财务列表</p>
                                </a>
                            </li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div style="padding-top: 30px">
                                        <button onclick="DataTables.deleteMulti('/finance/delete')" type="button" class="btn btn-danger btn-xs text-white"><i class="fas fa fa-trash"></i>删除</button>&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    $(function () {
        var columns = [
            ...
            { "data": "createtime" },
            {"data":function ( row, type, val, meta ) {
                    return '<Button onclick="DataTables.deleteOne(\'/finance/delete\',\''+row.financeId+'\')" type="button" class="btn btn-danger btn-xs text-white"><i class="fas fa fa-trash"></i>删除</Button>'
                }
            },
        ];
        dataTable=DataTables.initDataTable("/finance/page",columns);
    });
    //搜索方法
