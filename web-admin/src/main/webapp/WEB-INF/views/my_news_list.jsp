            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/news/my_news_list" class="nav-link active">
                                    <i class="far nav-icon fa fa-list-alt"></i>
                                    <p>新闻列表</p>
                                </a>
                            </li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div style="padding-top: 30px">
                                        <a href="/news/getForm" type="button" class="btn btn-default btn-xs"><i class="fas fa-plus"></i>添加</a>&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    $(function () {
        ...
        dataTable=DataTables.initDataTable("/news/mypage",columns);
    });
    //搜索方法
    ...
    //ajax把数据发送到controller
    function newsDetail() {
        var newsId = $("#newsIdDetail").val();
        $.ajax({
            "url":"/news/my_news_detail",
            "type":"GET",
            "data":{
                "id":newsId
            },
