                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/notice/notice_form" class="nav-link active">
                                    <i class="far nav-icon fa fa-list-alt"></i>
                                    <p>发布公告</p>
                                </a>
                            </li>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                ...
                                <h3 class="card-title">${notice.noticesId==null ? "新增" : "编辑"}公告</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form:form id="inputForm" class="form-horizontal" action="/notice/save" method="post" modelAttribute="notice">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="noticesTitle" class="col-sm-2 col-form-label">公告标题：</label>
                                        <div class="col-sm-10">
                                            <form:hidden path="noticesId"></form:hidden>
                                            <form:input path="noticesTitle" class="required form-control" placeholder="请输入公告标题"></form:input>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="noticesContent" class="col-sm-2 col-form-label">公告内容：</label>
                                        <div class="col-sm-10">
                                            <form:textarea rows="10" path="noticesContent" class="required form-control" placeholder="请输入公告内容"></form:textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
