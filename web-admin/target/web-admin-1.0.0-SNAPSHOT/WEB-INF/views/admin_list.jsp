                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/admin/admin_list" class="nav-link active">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <input id="realName" class="form-control" placeholder="请输入管理员名称"></input>
                                    </div>
                                    <div class="col-sm-3">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div style="padding-top: 30px">
                                        <a href="/admin/admin_form" type="button" class="btn btn-default btn-xs"><i class="fas fa-plus"></i>添加</a>&nbsp;&nbsp;&nbsp;
                                        <button onclick="DataTables.deleteMulti('/admin/delete')" type="button" class="btn btn-danger btn-xs"><i class="fas fa-plus"></i>删除</button>&nbsp;&nbsp;&nbsp;
    ...
    $(function () {
        var columns = [
            {"data":function ( row, type, val, meta ) {
                    return '<input type="checkbox" class="check check_one" id="'+row.adminId+'">'
                }
            },
            { "data": "adminId" },
            { "data": "realName" },
            ...
            { "data":"possition"},
            {"data":function ( row, type, val, meta ) {
                    var showDetailUrl = "/admin/admin_detail?id="+row.adminId;
                    return '<Button onclick="Detail.showDetail(\''+showDetailUrl+'\')" type="button" class="btn btn-default btn-xs"><i class="fas fa-search"></i>查看</Button>&nbsp;&nbsp;&nbsp;'+
                        '<a href="/admin/admin_form?id='+row.adminId+'" type="button" class="btn btn-primary btn-xs text-white"><i class="fas fa-edit"></i>编辑</a>&nbsp;&nbsp;&nbsp;'+
                        '<Button onclick="DataTables.deleteOne(\'/admin/delete\',\''+row.adminId+'\')" type="button" class="btn btn-danger btn-xs text-white"><i class="fas fa-trash"></i>删除</Button>'
                }
            }
        ];
        dataTable=DataTables.initDataTable("/admin/page",columns);
    });
    //搜索方法
