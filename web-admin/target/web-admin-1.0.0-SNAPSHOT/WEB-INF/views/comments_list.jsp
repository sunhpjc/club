            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/comments/comments_list" class="nav-link active">
                                    <i class="far nav-icon fa fa-list-alt"></i>
                                    <p>评论列表</p>
                                </a>
                            </li>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div style="padding-top: 30px">
                                        <button onclick="DataTables.deleteMulti('/comments/delete')" type="button" class="btn btn-danger btn-xs text-white"><i class="fas fa fa-trash"></i>删除</button>&nbsp;&nbsp;&nbsp;
    ...
    $(function () {
        var columns = [
            {"data":function ( row, type, val, meta ) {
                    return '<input type="checkbox" class="check check_one" id="'+row.commentsId+'">'
                }
            },
            { "data": "commentsId" },
            { "data": "realName" },
            ...
            { "data":"cmCreatetime"},
            {"data":function ( row, type, val, meta ) {
                    return '<Button onclick="DataTables.deleteOne(\'/comments/delete\',\''+row.commentsId+'\')" type="button" class="btn btn-danger btn-xs text-white"><i class="fas fa fa-trash"></i>删除</Button>'
                }
            },
        ];
        dataTable=DataTables.initDataTable("/comments/page",columns);
    });
    //搜索方法
