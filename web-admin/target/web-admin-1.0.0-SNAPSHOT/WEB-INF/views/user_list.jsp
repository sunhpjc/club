            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/user/user_list" class="nav-link active">
                                    <i class="far nav-icon fa fa-list-alt"></i>
                                    <p>用户列表</p>
                                </a>
                            </li>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <input id="realName" class="form-control" placeholder="请输入社员名字"></input>
                                    </div>
                                    <div class="col-sm-3">
                                        <input id="number" class="form-control" placeholder="请输入社员学号"></input>
                                    </div>
                                    <div class="col-sm-3">
                                        <input id="userEmail" class="form-control" placeholder="请输入社员邮箱"></input>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div style="padding-top: 30px">
                                        <a href="/user/user_form" type="button" class="btn btn-default btn-xs"><i class="fas fa-plus"></i>添加</a>&nbsp;&nbsp;&nbsp;
                                        <button onclick="DataTables.deleteMulti('/user/delete')" type="button" class="btn btn-danger btn-xs"><i class="fas fa-minus"></i>删除</button>&nbsp;&nbsp;&nbsp;
    ...
    $(function () {
        var columns = [
            {"data":function ( row, type, val, meta ) {
                    return '<input type="checkbox" class="check check_one" id="'+row.userId+'">'
                }
            },
            { "data": "userId" },
            { "data": "userEmail" },
            ...
            {"data":function ( row, type, val, meta ) {
                    return '<a href="/user/user_form_edit?id='+row.userId+'" type="button" class="btn btn-primary btn-xs text-white"><i class="fas fa-edit"></i>编辑</a>&nbsp;&nbsp;&nbsp;'+
                        '<Button onclick="DataTables.deleteOne(\'/user/delete\',\''+row.userId+'\')" type="button" class="btn btn-danger btn-xs text-white"><i class="fas fa-trash"></i>删除</Button>'
                }
            },
        ];
        dataTable=DataTables.initDataTable("/user/page?clubId=${adminUser_session.clubId}",columns);
    });
    //搜索方法
