                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-sm-3">
                                        <input id="name" class="form-control" placeholder="请输入活动名称"></input>
                                    </div>
    ...
    $(function () {
        var columns = [
            {"data":function ( row, type, val, meta ) {
                    return '<input type="checkbox" disabled="true" class="check check_one" id="'+row.ActivityId+'">'
                }
            },
            { "data": "activityId" },
            { "data": "name" },
            { "data":function (row, type, val, meta) {
                    return DateTime.format(row.time,"yy-MM-dd");
                }},
            { "data":"place"},
            ...
            {"data":function ( row, type, val, meta ) {
                    ...
                    return '<Button onclick="Detail.showDetail(\''+showDetailUrl+'\')" type="button" class="btn btn-default btn-xs"><i class="fas fa-search"></i>查看</Button>&nbsp;&nbsp;&nbsp;'+
                        '<a href="/activity/joinActivity?activityId='+row.activityId+'" type="button" class="btn btn-success btn-xs text-white"><i class="fa fa-plus"></i>加入</a>&nbsp;&nbsp;&nbsp;'
                }
            },
        ];
        dataTable=DataTables.initDataTable("/activity/page",columns);
    });
    //搜索方法
