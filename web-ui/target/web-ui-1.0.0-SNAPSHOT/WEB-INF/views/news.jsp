        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="/news/queryNews" class="nav-link active">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h5 class="m-0 text-dark">新闻分享中心</h5>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card card-info">
                            <!-- /.card-header -->
                            <!-- form start -->
                            <%--<form id="join" class="form-horizontal" action="/club/saveApplicationExit" method="post">
                                <div class="card-body">
                            ...
                            <table cellspacing="0" cellpadding="0" class="table table-bordered" style="border-style: none">
                                <tbody style="line-height: 7px">
                                    <c:forEach items="${newsList}" var="item">
                                        <tr>
                                            <td style="width: 75%;border-style: none">
                                                <a href="/news/newsDetail?id=${item.newsId}">${item.newsTitle}</a>
                                            </td>
                                            <td style="border-style: none;font-size: 10px">${item.name}</td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
                            </table>
